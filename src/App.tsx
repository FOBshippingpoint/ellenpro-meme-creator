    ...
    <Flex>
      ...
      <Box w="700px" pt="$10">
        <VStack>
          ...
          />
          <Divider />
          <HStack pt="$4" gap="$4" pb="$4" color="grey">
            <a href="https://github.com/FOBshippingpoint/ellenpro-meme-creator">
              <svg
            ...
            <a href="https://www.youtube.com/channel/UC-UzF0F_qnMhwy9oB-DyWsg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
          ...
          <Text color="grey">Made with ❤️ by FOBShippingPoint</Text>
        </VStack>
      </Box>
    </Flex>
  );
